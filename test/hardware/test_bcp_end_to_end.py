...
def test_bcp_end_to_end():
    ...
    async def testbench(ctx):
        ...
        async def write_clause(cid, c):
            ctx.set(cmem.wr_addr, cid)
            ctx.set(cmem.wr_data_sat_bit, c["sat_bit"])
            ctx.set(cmem.wr_data_size, c["size"])
            ctx.set(cmem.wr_data_lit0, c["lits"][0])
            ctx.set(cmem.wr_data_lit1, c["lits"][1])
            ctx.set(cmem.wr_data_lit2, c["lits"][2])
            ctx.set(cmem.wr_data_lit3, c["lits"][3])
            ctx.set(cmem.wr_data_lit4, c["lits"][4])
